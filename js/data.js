/**
 * Country dataset for Flag Quest.
 * Each entry: { code: ISO-3166 alpha-2 (lowercase), name, region, aliases:[] }
 * `aliases` are extra accepted spellings for the "Type the Country" mode
 * (always lowercase, no accents). The display `name` is matched automatically.
 */
const COUNTRIES = [
  // ---------------- Africa ----------------
  ...
  { code: "cg", name: "Republic of the Congo", region: "Africa", aliases: ["congo", "congo brazzaville"] },
  { code: "cd", name: "DR Congo", region: "Africa", aliases: ["democratic republic of the congo", "drc", "congo kinshasa"] },
  { code: "ci", name: "Ivory Coast", region: "Africa", aliases: ["cote divoire", "cote d ivoire"] },
  ...
  { code: "gw", name: "Guinea-Bissau", region: "Africa", aliases: ["guinea bissau"] },
  ...
  { code: "bs", name: "Bahamas", region: "Americas", aliases: ["the bahamas"] },
  ...
  { code: "us", name: "United States", region: "Americas", aliases: ["usa", "united states of america", "america"] },
  ...
  { code: "tl", name: "Timor-Leste", region: "Asia", aliases: ["east timor", "timor leste"] },
  { code: "tr", name: "Turkey", region: "Asia", aliases: ["turkiye"] },
  { code: "tm", name: "Turkmenistan", region: "Asia" },
  { code: "ae", name: "United Arab Emirates", region: "Asia", aliases: ["uae"] },
  ...
  { code: "ba", name: "Bosnia and Herzegovina", region: "Europe", aliases: ["bosnia"] },
  { code: "bg", name: "Bulgaria", region: "Europe" },
  { code: "hr", name: "Croatia", region: "Europe" },
  { code: "cy", name: "Cyprus", region: "Europe" },
  { code: "cz", name: "Czechia", region: "Europe", aliases: ["czech republic"] },
  ...
  { code: "va", name: "Vatican City", region: "Europe", aliases: ["vatican"] },
